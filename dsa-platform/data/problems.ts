...
export interface Problem {
  ...
  /** LeetCode locks this one behind a paid subscription. */
  premium?: boolean;
  /** Free mirror of a premium problem — a GeeksforGeeks article covering the
   *  same problem, so the statement is still reachable without paying. */
  freeUrl?: string;
}

/**
 * Where to actually send someone to read the problem. Premium problems would
 * hit a paywall on LeetCode, so they route to their free mirror instead.
 */
export function practiceUrl(p: Pick<Problem, "leetcodeUrl" | "premium" | "freeUrl">): string {
  return p.premium && p.freeUrl ? p.freeUrl : p.leetcodeUrl;
}

/** Label for the practice link, so the UI never says "LeetCode" for a GfG URL. */
export function practiceLabel(p: Pick<Problem, "premium" | "freeUrl">): string {
  return p.premium && p.freeUrl ? "GeeksforGeeks" : "LeetCode";
}
...
for (int i = 0; i < nums.size(); i++) {
    ...
    problems: [
      ...
      { id: "encode-decode-strings", title: "Encode and Decode Strings", difficulty: "Medium", difficultyScore: 5, pattern: "arrays-hashing", leetcodeUrl: "https://leetcode.com/problems/encode-and-decode-strings/", hasVisualization: false, tags: ["String", "Design"], companies: ["Google", "Amazon"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/serialize-deserialize-array-string/" },
...
while (fast && fast->next) {
    ...
    problems: [
      ...
      { id: "remove-duplicates", title: "Remove Duplicates from Sorted Array", difficulty: "Easy", difficultyScore: 3, pattern: "two-pointers", leetcodeUrl: "https://leetcode.com/problems/remove-duplicates-from-sorted-array/", hasVisualization: false, tags: ["Array", "Two Pointers"], companies: ["Amazon", "Microsoft", "Apple"], frequency: "High" },
      { id: "merge-sorted-array", title: "Merge Sorted Array", difficulty: "Easy", difficultyScore: 4, pattern: "two-pointers", leetcodeUrl: "https://leetcode.com/problems/merge-sorted-array/", hasVisualization: false, tags: ["Array", "Two Pointers", "Sorting"], companies: ["Amazon", "Microsoft", "Meta"], frequency: "High" },
      ...
      { id: "sort-colors", title: "Sort Colors", difficulty: "Medium", difficultyScore: 5, pattern: "two-pointers", leetcodeUrl: "https://leetcode.com/problems/sort-colors/", hasVisualization: false, tags: ["Array", "Two Pointers", "Sorting"], companies: ["Amazon", "Microsoft", "Google"], frequency: "High" },
      ...
      { id: "remove-duplicates-ii", title: "Remove Duplicates from Sorted Array II", difficulty: "Medium", difficultyScore: 5, pattern: "two-pointers", leetcodeUrl: "https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/", hasVisualization: false, tags: ["Array", "Two Pointers"], companies: ["Amazon", "Microsoft"], frequency: "High" },
      { id: "next-permutation", title: "Next Permutation", difficulty: "Medium", difficultyScore: 6, pattern: "two-pointers", leetcodeUrl: "https://leetcode.com/problems/next-permutation/", hasVisualization: false, tags: ["Array", "Two Pointers"], companies: ["Amazon", "Google", "Meta"], frequency: "High" },
...
for (int i = 1; i <= n; i++) diff[i] += diff[i-1];`,
    ...
    problems: [
      ...
      { id: "range-addition", title: "Range Addition", difficulty: "Medium", difficultyScore: 6, pattern: "prefix-sum", leetcodeUrl: "https://leetcode.com/problems/range-addition/", hasVisualization: false, tags: ["Array", "Prefix Sum", "Difference Array"], companies: ["Google", "Amazon"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/difference-array-range-update-query-o1/" },
...
for (int i = k; i < n; i++) {
    ...
    problems: [
      ...
      { id: "fruit-into-baskets", title: "Fruit Into Baskets", difficulty: "Medium", difficultyScore: 6, pattern: "sliding-window", leetcodeUrl: "https://leetcode.com/problems/fruit-into-baskets/", hasVisualization: false, tags: ["Array", "Hash Map", "Sliding Window"], companies: ["Google", "Amazon"], frequency: "Medium" },
      { id: "max-consecutive-ones-iii", title: "Max Consecutive Ones III", difficulty: "Medium", difficultyScore: 6, pattern: "sliding-window", leetcodeUrl: "https://leetcode.com/problems/max-consecutive-ones-iii/", hasVisualization: false, tags: ["Array", "Sliding Window"], companies: ["Google", "Amazon"], frequency: "Medium" },
      { id: "subarray-product-less-k", title: "Subarray Product Less Than K", difficulty: "Medium", difficultyScore: 6, pattern: "sliding-window", leetcodeUrl: "https://leetcode.com/problems/subarray-product-less-than-k/", hasVisualization: false, tags: ["Array", "Sliding Window"], companies: ["Google", "Amazon"], frequency: "Medium" },
      ...
      { id: "minimum-window-subsequence", title: "Minimum Window Subsequence", difficulty: "Hard", difficultyScore: 9, pattern: "sliding-window", leetcodeUrl: "https://leetcode.com/problems/minimum-window-subsequence/", hasVisualization: true, tags: ["String", "Sliding Window", "Two Pointers", "DP"], companies: ["Google", "Facebook"], frequency: "High", premium: true, freeUrl: "https://www.geeksforgeeks.org/minimum-window-subsequence/" },
    ]
  },
  {
    id: "stack",
...
for (int i = 0; i < n; i++) {
    ...
    problems: [
      ...
      { id: "implement-queue-using-stacks", title: "Implement Queue using Stacks", difficulty: "Easy", difficultyScore: 4, pattern: "stack", leetcodeUrl: "https://leetcode.com/problems/implement-queue-using-stacks/", hasVisualization: false, tags: ["Stack", "Design", "Queue"], companies: ["Amazon", "Microsoft"], frequency: "Medium" },
...
return lo;`,
    ...
    problems: [
      ...
      { id: "find-first-last-position", title: "Find First and Last Position of Element in Sorted Array", difficulty: "Medium", difficultyScore: 5, pattern: "binary-search", leetcodeUrl: "https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/", hasVisualization: false, tags: ["Array", "Binary Search"], companies: ["Amazon", "Google", "Microsoft", "Meta"], frequency: "High" },
      ...
      { id: "find-peak-element", title: "Find Peak Element", difficulty: "Medium", difficultyScore: 6, pattern: "binary-search", leetcodeUrl: "https://leetcode.com/problems/find-peak-element/", hasVisualization: false, tags: ["Array", "Binary Search"], companies: ["Amazon", "Google"], frequency: "Medium" },
      { id: "capacity-ship-packages", title: "Capacity To Ship Packages Within D Days", difficulty: "Medium", difficultyScore: 7, pattern: "binary-search", leetcodeUrl: "https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/", hasVisualization: false, tags: ["Array", "Binary Search"], companies: ["Amazon", "Google"], frequency: "Medium" },
      ...
      { id: "split-array-largest-sum", title: "Split Array Largest Sum", difficulty: "Hard", difficultyScore: 9, pattern: "binary-search", leetcodeUrl: "https://leetcode.com/problems/split-array-largest-sum/", hasVisualization: false, tags: ["Array", "Binary Search", "DP"], companies: ["Google", "Amazon"], frequency: "Medium" },
    ]
  },
  {
    id: "linked-list",
...
return nullptr;`,
    ...
    problems: [
      ...
      { id: "reverse-linked-list-ii", title: "Reverse Linked List II", difficulty: "Medium", difficultyScore: 6, pattern: "linked-list", leetcodeUrl: "https://leetcode.com/problems/reverse-linked-list-ii/", hasVisualization: false, tags: ["Linked List"], companies: ["Amazon", "Microsoft", "Meta"], frequency: "High" },
...
while (!q.empty()) {
    ...
    problems: [
      ...
      { id: "zigzag-level-order", title: "Binary Tree Zigzag Level Order Traversal", difficulty: "Medium", difficultyScore: 6, pattern: "trees", leetcodeUrl: "https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/", hasVisualization: false, tags: ["Tree", "BFS"], companies: ["Amazon", "Microsoft", "Meta"], frequency: "High" },
      { id: "path-sum-ii", title: "Path Sum II", difficulty: "Medium", difficultyScore: 6, pattern: "trees", leetcodeUrl: "https://leetcode.com/problems/path-sum-ii/", hasVisualization: false, tags: ["Tree", "DFS", "Backtracking"], companies: ["Amazon", "Google"], frequency: "Medium" },
      { id: "boundary-traversal-tree", title: "Boundary Traversal of Binary Tree", difficulty: "Medium", difficultyScore: 6, pattern: "trees", leetcodeUrl: "https://www.geeksforgeeks.org/boundary-traversal-of-binary-tree/", hasVisualization: false, tags: ["Tree", "DFS"], companies: ["Amazon", "Flipkart"], frequency: "Medium" },
      ...
      { id: "vertical-order-traversal", title: "Binary Tree Vertical Order Traversal", difficulty: "Hard", difficultyScore: 8, pattern: "trees", leetcodeUrl: "https://leetcode.com/problems/vertical-order-traversal-of-a-binary-tree/", hasVisualization: false, tags: ["Tree", "BFS", "DFS", "Sorting"], companies: ["Amazon", "Microsoft"], frequency: "Medium" },
    ]
  },
  {
    id: "heap",
...
void unite(int x, int y) { parent[find(x)] = find(y); }`,
    ...
    problems: [
      ...
      { id: "walls-gates", title: "Walls and Gates", difficulty: "Medium", difficultyScore: 6, pattern: "graphs", leetcodeUrl: "https://leetcode.com/problems/walls-and-gates/", hasVisualization: true, tags: ["Array", "BFS"], companies: ["Amazon", "Facebook"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/distance-nearest-cell-1-binary-matrix/" },
      ...
      { id: "graph-valid-tree", title: "Graph Valid Tree", difficulty: "Medium", difficultyScore: 7, pattern: "graphs", leetcodeUrl: "https://leetcode.com/problems/graph-valid-tree/", hasVisualization: true, tags: ["DFS", "BFS", "Union Find"], companies: ["Amazon", "Google"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/check-given-graph-tree/" },
      { id: "num-connected-components", title: "Number of Connected Components", difficulty: "Medium", difficultyScore: 6, pattern: "graphs", leetcodeUrl: "https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/", hasVisualization: true, tags: ["DFS", "BFS", "Union Find"], companies: ["LinkedIn", "Amazon"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/connected-components-in-an-undirected-graph/" },
      ...
      { id: "is-graph-bipartite", title: "Is Graph Bipartite?", difficulty: "Medium", difficultyScore: 6, pattern: "graphs", leetcodeUrl: "https://leetcode.com/problems/is-graph-bipartite/", hasVisualization: false, tags: ["Graph", "BFS", "DFS", "Union Find"], companies: ["Google", "Amazon", "Meta"], frequency: "Medium" },
...
for (auto& [s, e] : intervals) {
    ...
    problems: [
      { id: "lemonade-change", title: "Lemonade Change", difficulty: "Easy", difficultyScore: 3, pattern: "greedy", leetcodeUrl: "https://leetcode.com/problems/lemonade-change/", hasVisualization: true, tags: ["Array", "Greedy"], companies: ["Amazon", "Bloomberg"], frequency: "Medium" },
...
return ends.size(); // rooms needed`,
    ...
    problems: [
      { id: "meeting-rooms", title: "Meeting Rooms", difficulty: "Easy", difficultyScore: 4, pattern: "intervals", leetcodeUrl: "https://leetcode.com/problems/meeting-rooms/", hasVisualization: false, tags: ["Array", "Sorting"], companies: ["Amazon", "Facebook"], frequency: "Medium", premium: true, freeUrl: "https://www.geeksforgeeks.org/check-if-any-two-intervals-overlap-among-a-given-set-of-intervals/" },
      ...
      { id: "meeting-rooms-ii", title: "Meeting Rooms II", difficulty: "Medium", difficultyScore: 7, pattern: "intervals", leetcodeUrl: "https://leetcode.com/problems/meeting-rooms-ii/", hasVisualization: false, tags: ["Array", "Sorting", "Heap"], companies: ["Amazon", "Google", "Facebook"], frequency: "High", premium: true, freeUrl: "https://www.geeksforgeeks.org/minimum-number-platforms-required-railwaybus-station/" },
      ...
      { id: "employee-free-time", title: "Employee Free Time", difficulty: "Hard", difficultyScore: 8, pattern: "intervals", leetcodeUrl: "https://leetcode.com/problems/employee-free-time/", hasVisualization: true, tags: ["Array", "Sorting", "Heap", "Intervals"], companies: ["Google", "Amazon", "Uber"], frequency: "High", premium: true, freeUrl: "https://www.geeksforgeeks.org/merging-intervals/" },
    ]
  },
  {
    id: "math-geometry",
...
return a;`,
    ...
    problems: [
      ...
      { id: "single-number-ii", title: "Single Number II", difficulty: "Medium", difficultyScore: 6, pattern: "bit-manipulation", leetcodeUrl: "https://leetcode.com/problems/single-number-ii/", hasVisualization: false, tags: ["Array", "Bit Manipulation"], companies: ["Amazon", "Google"], frequency: "Medium" },
      { id: "single-number-iii", title: "Single Number III", difficulty: "Medium", difficultyScore: 7, pattern: "bit-manipulation", leetcodeUrl: "https://leetcode.com/problems/single-number-iii/", hasVisualization: false, tags: ["Array", "Bit Manipulation"], companies: ["Amazon", "Microsoft"], frequency: "Medium" },
...
public:
    ...
    problems: [
      { id: "index-pairs-string", title: "Index Pairs of a String", difficulty: "Easy", difficultyScore: 4, pattern: "tries", leetcodeUrl: "https://leetcode.com/problems/index-pairs-of-a-string/", hasVisualization: false, tags: ["Trie", "String", "Sorting"], companies: ["LinkedIn", "Amazon"], frequency: "Low", premium: true, freeUrl: "https://www.geeksforgeeks.org/aho-corasick-algorithm-pattern-searching/" },
      ...
      { id: "design-search-autocomplete", title: "Design Search Autocomplete System", difficulty: "Hard", difficultyScore: 10, pattern: "tries", leetcodeUrl: "https://leetcode.com/problems/design-search-autocomplete-system/", hasVisualization: true, tags: ["Trie", "Design", "String", "Sorting"], companies: ["Google", "Amazon", "Microsoft"], frequency: "High", premium: true, freeUrl: "https://www.geeksforgeeks.org/auto-complete-feature-using-trie/" },
    ]
  },
  {
    id: "advanced-graphs",
...
for (int i = 0; i < K+1; i++) {
    ...
    problems: [
      ...
      { id: "alien-dictionary", title: "Alien Dictionary", difficulty: "Hard", difficultyScore: 9, pattern: "advanced-graphs", leetcodeUrl: "https://leetcode.com/problems/alien-dictionary/", hasVisualization: true, tags: ["String", "Graph", "Topological Sort"], companies: ["Facebook", "Airbnb", "Google"], frequency: "High", premium: true, freeUrl: "https://www.geeksforgeeks.org/given-sorted-dictionary-find-precedence-characters/" },
