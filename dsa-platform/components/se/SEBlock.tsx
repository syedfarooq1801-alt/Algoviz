...
export default function SEBlock({ block }: { block: Block }) {
  ...
  return (
    <aside className="my-7 max-w-[760px] px-4 py-3" style={{ background: callout.bg, borderLeft: `2px solid ${callout.color}` }}>
...
function InterviewBlock({ qas }: { qas: { q: string; a: string }[] }) {
  return (
    <section className="my-9 max-w-[760px] px-4 py-3" style={{ background: "rgba(245,166,35,0.04)", borderLeft: "2px solid var(--accent-orange)" }}>
