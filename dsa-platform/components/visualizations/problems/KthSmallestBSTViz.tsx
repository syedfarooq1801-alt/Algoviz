    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-xl p-4" style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}>
          ...
          <svg width="350" height="210" viewBox="0 0 350 210" style={{ width: "100%", height: "auto" }} role="img" aria-label="Binary search tree with in-order traversal to find kth smallest">
